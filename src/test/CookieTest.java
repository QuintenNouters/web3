...
public class CookieTest {
	...
	public void setUp() {
		...
		driver.get("http://localhost:8080/Web3_project_herexamen/Controller");
	}
	...
	public void testOverviewUsersSwithcColorTwiceCorrect() {
		driver.get("http://localhost:8080/Web3_project_herexamen/Controller?action=UserOverviewPage");
		// first change
	...
	public void testSwitchColorAfterUpdateProductCorrect() {
		...
		driver.get("http://localhost:8080/Web3_project_herexamen/Controller?action=productOverviewPage");
