...
public class ProductOverviewPageHandler implements RequestHandler{
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user != null && roles.contains(user.getRole())) {
			...
			request.setAttribute("error", "the page \"Product Overview\" is only for administrators or customers. Please log in to get access");
